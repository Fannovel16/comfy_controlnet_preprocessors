...
from custom_nodes.comfy_controlnet_preprocessors.v11.inpaint_lama.saicinpainting.training.losses.distance_weighting import make_mask_distance_weighter
from custom_nodes.comfy_controlnet_preprocessors.v11.inpaint_lama.saicinpainting.training.losses.feature_matching import feature_matching_loss, masked_l1_loss
# from annotator.lama.saicinpainting.training.modules.fake_fakes import FakeFakesGenerator
from custom_nodes.comfy_controlnet_preprocessors.v11.inpaint_lama.saicinpainting.training.trainers.base import BaseInpaintingTrainingModule, make_multiscale_noise
from custom_nodes.comfy_controlnet_preprocessors.v11.inpaint_lama.saicinpainting.utils import add_prefix_to_keys, get_ramp
